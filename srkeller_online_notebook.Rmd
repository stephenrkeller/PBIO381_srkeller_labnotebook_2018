...
This notebook will catalog my entires throughout the semester, including all my code and results, and interpretations
...
I used the Putty program and entered the following commands:

```
ip0af52955:~ srkeller$ ssh srkeller@pbio381.uvm.edu
srkeller@pbio381.uvm.edu's password: 
Last login: Wed Jan 24 13:13:54 2018 from ip0af52955.int.uvm.edu
[srkeller@pbio381 ~]$
```
